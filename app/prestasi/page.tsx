...
const PRESTASI = [
  {
    tahun: '2025',
    nama: 'JUARA 2 Tingkat Nasional | ISSC3 PIALA GUBERNUR DKI JAKARTA 2025',
    kategori: 'Olahraga',
    foto: '/images/prestasi1.jpg',
    href: '/detail_prestasi/page1',
  },
  {
    tahun: '2025',
    nama: 'JUARA 1 Tingkat Nasional | ISSC3 PIALA GUBERNUR DKI JAKARTA 2025',
    kategori: 'Olahraga',
    foto: '/images/prestasi2.jpg',
    href: '/detail_prestasi/page2',
  },
  {
    tahun: '2025',
    nama: 'JUARA 3 Singing Competition HUT YS Media Link ke 3th',
    kategori: 'Seni',
    foto: '/images/prestasi3.jpg',
    href: '/detail_prestasi/page3',
  },
  {
    tahun: '2024',
    nama: 'JUARA 2 FASA TOURNAMENT SE-JABODETABEK',
    kategori: 'Olahraga',
    foto: '/images/prestasi4.jpeg',
    href: '/detail_prestasi/page4',
  },
  {
    tahun: '2024',
    nama: 'JUARA 1 Lomba Tari Kreasi Daerah Tingkat Umum',
    kategori: 'Seni',
    foto: '/images/prestasi5.jpeg',
    href: '/detail_prestasi/page5',
  },
  {
    tahun: '2023',
    nama: 'JUARA 1 & 2 Kompetisi Taekwondo Tingkat Kota',
    kategori: 'Olahraga',
    foto: '/images/prestasi6.jpg',
    href: '/detail_prestasi/page6',
  },
  {
    tahun: '2023',
    nama: 'JUARA 2 Kompetisi Story Telling Tingkat Nasional',
    kategori: 'Seni',
    foto: '/images/prestasi7.jpg',
    href: '/detail_prestasi/page7',
  },
  {
    tahun: '2023',
    nama: 'JUARA 1 Kompetisi Story Telling Tingkat Nasional',
    kategori: 'Seni',
    foto: '/images/prestasi8.jpg',
    href: '/detail_prestasi/page8',
  },
  {
    tahun: '2023',
    nama: 'JUARA 1 Kompetisi Tari Tradisional Tingkat Kota Depok',
    kategori: 'Seni',
    foto: '/images/prestasi9.jpg',
    href: '/detail_prestasi/page9',
  },
];
...
export default function PrestasiPage() {
  ...
  return (
    <>
      ...
      <main>
        {/* Hero */}
        <section className="hero-gradient" style={{ padding: 'clamp(48px, 8vw, 80px) 24px' }}>
          <div style={{ maxWidth: 800, margin: '0 auto', textAlign: 'center' }}>
            <div className="gold-line" style={{ margin: '0 auto 20px' }} />
            <h1 className="font-display" style={{ fontSize: 'clamp(30px, 6vw, 48px)', color: 'white', marginBottom: 16, lineHeight: 1.2 }}>
              Prestasi & Penghargaan
            </h1>
            <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: 'clamp(14px, 2vw, 17px)', lineHeight: 1.7, maxWidth: 560, margin: '0 auto' }}>
              Deretan pencapaian membanggakan siswa-siswi SMP Citra Negara di berbagai bidang kompetisi.
            </p>
          </div>
        </section>
        ...
        <section style={{ background: '#023d17', padding: '22px 24px', borderBottom: '2px solid #C8973A' }}>
          <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', gap: 40, justifyContent: 'center', flexWrap: 'wrap' }}>
            {[
              ...
              { label: 'Tingkat Nasional', val: '4' },
              { label: 'Tingkat Jabodetabek', val: '4' },
              { label: 'Tingkat Umum', val: '1' },
              { label: 'Bidang', val: '3' },
            ].map(s => (
        ...
        <section style={{ background: '#FAF7F0', padding: '32px 24px 0' }}>
          <div style={{
            maxWidth: 1100, margin: '0 auto', display: 'flex', gap: 8,
        ...
        <section style={{ padding: '32px 24px 70px', background: '#FAF7F0' }}>
          <div style={{
            ...
            {filtered.map((p, i) => (
              ...
              >
                {/* Foto */}
                <div style={{ position: 'relative', width: '100%', aspectRatio: '3 / 4', overflow: 'hidden', background: '#F0EBE0' }}>
