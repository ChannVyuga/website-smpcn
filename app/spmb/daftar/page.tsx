...
export default function DaftarPage() {
      ...
      <header style={{ background: 'linear-gradient(180deg, #123524 0%, #0B2A1C 100%)', borderBottom: '2px solid #C8973A', padding: '0 24px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', display: 'flex', alignItems: 'center', height: 64 }}>
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
            ...
            <span style={{ color: 'white', fontWeight: 700, fontSize: 14 }}>Formulir SPMB 2026 — SMP Citra Negara</span>
          </Link>
        </div>
      </header>
  ...
  <div style={{ background: '#F8F9FA', borderRadius: 12, padding: 24, marginBottom: 24, maxHeight: 380, overflowY: 'auto', border: '1px solid #E5E7EB' }}>
    ...
    {[
      'Sepenuh hati mempercayakan kepada SMP Citra Negara untuk memberikan pendidikan, pengajaran, dan pembinaan kepada putra/putri kami.',
      'Selama putra/putri saya menjadi peserta didik di SMP Citra Negara, saya mengizinkan untuk mengikuti seluruh agenda kegiatan yang diselenggarakan oleh sekolah.',
      'Bersedia memenuhi kewajiban-kewajiban sebagai orang tua/wali demi kelancaran proses pendidikan, pengajaran, dan pembinaan yang dilaksanakan oleh SMP Citra Negara.',
      ...
      'Bersedia memenuhi seluruh biaya pendidikan secara tepat waktu demi kelancaran dan keberhasilan seluruh kegiatan di SMP Citra Negara, yaitu setiap tanggal 5 sampai dengan 10 setiap bulannya.',
      ...
      `Menyetujui bahwa apabila putra/putri saya membatalkan sekolah di SMP Citra Negara Tahun Pelajaran 2026/2027, maka seluruh biaya pendidikan yang telah dibayarkan tidak dapat ditarik kembali dengan alasan apa pun. Khusus bagi peserta didik yang diterima di sekolah negeri, biaya dapat dikembalikan sebesar 50% dengan ketentuan:<ul style="margin-top:8px;padding-left:20px;list-style-type:disc;display:flex;flex-direction:column;gap:4px;"><li>Minimal telah melakukan pembayaran sebesar Rp1.000.000;</li><li>Menyerahkan surat keterangan diterima di sekolah negeri;</li><li>Dibuktikan melalui Website Resmi PPDB Online dari dinas terkait;</li><li>Pengajuan dilakukan maksimal 3 (tiga) hari setelah pengumuman penerimaan sekolah negeri.</li></ul>`,
      ...
      'Bersedia menerima hasil Tes dan seleksi administrasi keuangan, serta menerima segala keputusan yang ditetapkan oleh pihak SMP Citra Negara sebagai hasil akhir proses seleksi.',
    ].map((item, i) => (
