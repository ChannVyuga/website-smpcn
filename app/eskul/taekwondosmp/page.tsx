...
const STATS = [
  { angka: 2011, suffix: "", label: "Tahun Berdiri" },
  { angka: 35, suffix: "+", label: "Anggota Aktif" },
  { angka: 18, suffix: "", label: "Prestasi Diraih" },
...
const TUJUAN = [
  {
    ...
    judul: "Kedisiplinan",
    deskripsi:
      "Membentuk ketahanan mental dan kedisiplinan diri yang teguh melalui latihan terstruktur dan pembiasaan nilai-nilai integritas.",
  },
  {
    icon: "💪",
    judul: "Kebugaran & Bela Diri",
    deskripsi:
      "Mengasah kekuatan, kecepatan, dan refleks tubuh secara maksimal sekaligus membekali diri dengan teknik bela diri yang praktis dan efektif.",
  },
  {
    icon: "🏅",
    judul: "Pembentukan Karakter Positif",
    deskripsi:
      "Menumbuhkan rasa percaya diri, kesopanan, keberanian, dan rasa saling menghargai yang berguna di dalam maupun di luar arena latihan.",
  },
];
...
const KEGIATAN = [
  {
    no: "01",
    nama: "Teknik Dasar (Basic Skill)",
    detail:
      "Penguatan fondasi gerakan pukulan, tangkisan, dan teknik tendangan dasar.",
  },
  {
    no: "02",
    nama: "Latihan Jurus (Poomsae)",
    detail:
      "Penguasaan urutan gerak keindahan dan ketepatan teknik secara sistematis.",
  },
  {
    no: "03",
    nama: "Aplikasi Bertarung (Sparring)",
    detail:
      "Praktik pertarungan taktis dengan pengawasan ketat dan standar keamanan tinggi.",
  },
  {
    no: "04",
    nama: "Pembentukan Fisik (Physical Conditioning)",
    detail:
      "Latihan stamina, kelenturan, dan kekuatan fisik untuk menunjang performa.",
  },
  {
    no: "05",
    nama: "Ujian Sabuk (Gup Test)",
    detail:
      "Tahapan evaluasi berkala untuk kenaikan tingkat keterampilan siswa.",
  },
  {
    no: "06",
    nama: "Kompetisi & Turnamen",
    detail:
      "Wadah menyalurkan bakat dan melatih jiwa kompetitif dalam kejuaraan resmi.",
  },
];
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .psk-root {
          /* --- Unified color system, built from the core brand red #C62828 --- */
          --psk-red: #C62828;
          --psk-red-light: #E15252;
          --psk-red-dark: #8F1E1E;
          --psk-red-deep: #4A0F0F;
          --psk-red-tint: #FBE0E0;
          --psk-red-tint-soft: #FDF0F0;
          --psk-charcoal: #1C1C1C;
          --psk-black-deep: #151515;
          --psk-ink: #171717;
          --psk-paper: #F5F5F7;
          --psk-page-bg: #FFFFFF;

          font-family: 'Barlow', sans-serif;
          background: var(--psk-page-bg);
          color: var(--psk-ink);
          min-height: 100vh;
          overflow: hidden;
        }
        ...
        .psk-hero-overlay {
          ...
          inset: 0;
          background:
            radial-gradient(circle at 75% 35%, rgba(198,40,40,0.22), transparent 28%),
            ...
            linear-gradient(200deg, rgba(74,15,15,0.30) 0%, transparent 55%);
        }
        ...
        .psk-hero::after {
          ...
          height: 100px;
          background: linear-gradient(to bottom, transparent, var(--psk-page-bg));
          pointer-events: none;
          z-index: 3;
        }
        ...
        .psk-eyebrow::before {
          ...
          background: var(--psk-red-light);
          box-shadow: 0 0 15px rgba(198,40,40,0.75);
        }
        ...
        .psk-title {
          ...
          line-height: 0.8;
          letter-spacing: 3px;
          color: var(--psk-red-light);
          margin: 0 0 26px;
          text-shadow: 0 8px 40px rgba(0,0,0,0.35), 0 0 45px rgba(198,40,40,0.28);
        ...
        .psk-hero-button:hover {
          ...
          box-shadow: 0 10px 35px rgba(198,40,40,0.30);
        }
        ...
        .psk-stat {
          ...
          min-height: 125px;
          padding: 28px 20px;
          background: linear-gradient(135deg, var(--psk-red) 0%, var(--psk-red-dark) 55%, var(--psk-red-deep) 100%);
          text-align: center;
          border-right: 1px solid rgba(255,255,255,0.12);
          box-shadow: 0 12px 40px rgba(74,15,15,0.25);
          overflow: hidden;
        ...
        .psk-tujuan-card {
          ...
          min-height: 280px;
          background: linear-gradient(145deg, #fff 0%, #FBEFEF 100%);
        ...
        .psk-tujuan-card::before {
          ...
          background: linear-gradient(90deg, var(--psk-red), var(--psk-red-dark), var(--psk-charcoal));
          transform: scaleX(0);
        ...
        .psk-tujuan-card:hover {
          ...
          border-color: var(--psk-red);
          box-shadow: 0 22px 55px rgba(198,40,40,0.18);
        }
        ...
        .psk-tujuan-card:hover .psk-tujuan-icon {
          ...
          box-shadow: 0 8px 25px rgba(198,40,40,0.24);
        }
        ...
        .psk-divider::before, .psk-divider::after {
          content: '';
          height: 1px; flex: 1;
          background: linear-gradient(90deg, transparent, rgba(198,40,40,0.18));
        }

        .psk-divider::after {
          background: linear-gradient(90deg, rgba(198,40,40,0.18), transparent);
        }
        ...
        .psk-kegiatan-item[data-active="true"] {
          background: linear-gradient(135deg, #fff, var(--psk-red-tint-soft));
        }
        ...
        .psk-cta {
          position: relative;
          margin-top: 35px;
          background: radial-gradient(circle at 80% 30%, rgba(198,40,40,0.25), transparent 30%),
            linear-gradient(120deg, var(--psk-black-deep) 0%, var(--psk-red-deep) 65%, var(--psk-red) 140%);
          overflow: hidden;
        }
        ...
        .psk-cta::after {
          ...
          background: linear-gradient(180deg, var(--psk-red), var(--psk-charcoal));
        }
        ...
        .psk-cta-title span { color: var(--psk-red-light); }
        ...
        .psk-btn {
          ...
          justify-content: center;
          gap: 10px;
          background: linear-gradient(135deg, var(--psk-red), var(--psk-red-dark));
          color: #fff;
          font-family: 'Barlow Condensed', sans-serif;
          font-size: 14px;
          font-weight: 800;
        ...
        .psk-btn:hover {
          background: linear-gradient(135deg, var(--psk-red-light), var(--psk-red));
          transform: translateY(-3px);
        }
        ...
        @media (max-width: 700px) {
          ...
          .psk-hero-overlay {
            background:
              radial-gradient(circle at 70% 25%, rgba(198,40,40,0.20), transparent 35%),
        ...
        <main>
          ...
          <section ref={heroRef} className="psk-hero">
            <div className="psk-hero-img">
              <Image
                src="/images/taekwondosmp.jpg"
                alt="Taekwondo SMP Citra Negara"
                fill
                priority
              />
            ...
            <div className="psk-hero-content">
              ...
              <p className="psk-subtitle">
                Di setiap gerakan Taekwondo, tersimpan pelajaran tentang
                disiplin, ketekunan, dan rasa hormat. Kami tidak hanya melatih
                kemampuan bela diri, tetapi juga membentuk karakter yang kuat
                agar setiap siswa siap menghadapi tantangan, baik di dalam
          ...
          <section className="psk-section">
            <div className="psk-section-label psk-reveal">Mengapa Taekwondo</div>
            ...
            <div className="psk-cta-inner">
              <div className="psk-reveal">
                <h2 className="psk-cta-title">
                  SIAP JADI <span>PETARUNG?</span>
                </h2>
                <p className="psk-cta-sub">
                  Latih disiplin, kekuatan, dan rasa hormat bersama Taekwondo SMP Citra Negara.
                </p>
              </div>
            </div>
          </section>
