...
export default function PrestasiDetailPage() {
  ...
  const judul =
    "JUARA 1 LOMBA TARI KREASI DAERAH TINGKAT UMUM - RAMAYANA, CIPLAZ DEPOK";

  const foto = "/images/prestasi5.jpeg";
  const kategori = "Prestasi";
  const tanggal = "25 Desember 2024";

  const deskripsi = (
    <>
      Selamat kepada <strong>TARCA</strong> {" "} &#40;Tari Citra Negara&#41; karena berhasil mendapatkan
      juara 1 pada lomba Tari Kreasi Daerah Tingkat Umum yang diselenggarakan di Ramayana, Ciplaz Depok.
    </>
  );
