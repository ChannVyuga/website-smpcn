...
export default function PrestasiDetailPage() {
  ...
  const judul =
    "JUARA 3 SINGING COMPETITION - ROAD SHOW & COMPETITION HUT YS MEDIA LINK KE 3TH";

  const foto = "/images/prestasi3.jpg";
  const kategori = "Prestasi";
  const tanggal = "27 July 2025";

  const deskripsi = (
    <>
      Kami ucapkan selamat dan apresiasi setinggi-tingginya kepada Syarifah Zahirah Awaliyah dari kelas 9 PLUS 2 
      yang telah meraih juara 3 dalam {" "} <strong>Singing Competition pada acara Road Show & Competition HUT YS Media Link ke-3!</strong> {" "} 
      Suara emas Syarifah telah mengharumkan nama <strong>SMP Citra Negara</strong>. Teruslah kembangkan bakatmu!
    </>
  );
