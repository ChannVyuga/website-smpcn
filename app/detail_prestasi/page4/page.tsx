...
export default function PrestasiDetailPage() {
  ...
  const judul =
    "JUARA 2 TINGKAT SEJABODETABEK - FASA TOURNAMENT 2024";

  const foto = "/images/prestasi4.jpeg";
  const kategori = "Prestasi";
  const tanggal = "25 Desember 2024";

  const deskripsi = (
    <>
      Selamat atas prestasi gemilang yang telah diraih oleh tim TIM FUTSAL <strong>SMP Citra Negara</strong> sebagai
      juara 2 tingkat SEJABODETABEK dalam lomba <strong>FASA TOURNAMENT</strong> yang diselenggarakan pada tanggal 22 Desember 2024. <br /> <br />

      Semoga keberhasilan ini menjadi motivasi untuk terus berkarya dan meraih prestasi yang lebih tinggi.
    </>
  );
