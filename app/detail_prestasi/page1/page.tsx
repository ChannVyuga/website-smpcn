...
export default function PrestasiDetailPage() {
  ...
  const judul =
    "JUARA 2 TINGKAT NASIONAL! ISSC3 PIALA GUBERNUR DKI JAKARTA 2025";

  const foto = "/images/prestasi1.jpg";
  const kategori = "Prestasi";
  const tanggal = "15 September 2025";

  const deskripsi = (
    <>
      Prestasi membanggakan dari arena Taekwondo kembali dipersembahkan untuk{" "}
      <strong>SMP Citra Negara</strong>! Segenap keluarga besar Yayasan At-Taqwa
      Kemiri Jaya dan <strong>SMP Citra Negara</strong> Depok mengucapkan{" "}
      <b>SELAMAT!</b> kepada ananda, Cheryl Aurora dari kelas 9 plus 2 yang
      telah berhasil meraih <strong>JUARA TINGKAT 2 NASIONAL</strong> dalam{" "}
      <strong>Kejuaraan Taekwondo &ldquo;ISSC3 Piala Gubernur DKI Jakarta 2025&ldquo;</strong>
    </>
  );
