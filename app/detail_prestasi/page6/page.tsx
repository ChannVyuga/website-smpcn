...
export default function PrestasiDetailPage() {
  ...
  const judul =
    "SISWI SMP CITRA NEGARA MERAIH JUARA 1 DAN 2 KOMPETISI TAEKWONDO TINGKAT KOTA";

  const foto = "/images/prestasi6.jpg";
  const kategori = "Prestasi";
  const tanggal = "25 Desember 2023";

  const deskripsi = (
    <>
      Siswi <strong>SMP Citra Negara</strong> meraih prestasi pada kompetisi taekwondo tingkat kota. Tidak tanggung - tanggung
    siswi tersebut berhasil meraih juara 1 dan 2 dalam kompetisi tersebut! <br /> <br />

    Selamat kepada Evangelina Galista 8 REG 1 dan Azkya Shayna A.D 8 PLUS 1 karena telah meraih juara 1 dan 2 pada
    kompetisi taekwondo tingkat kota.
    </>
  );
