...
export default function PrestasiDetailPage() {
  ...
  const judul =
    "Siswi SMP Citra negara meraih juara 1 dan 2 kompetisi tekwondo tingkat kotaSiswi SMP Citra Negara Meraih Juara 2 Kompetisi Story Telling tingkat Nasional";

  const foto = "/images/prestasi7.jpg";
  const kategori = "Prestasi";
  const tanggal = "25 Desember 2023";

  const deskripsi = (
    <>
        Baru saja siswi <strong>SMP Citra Negara</strong> meraih juara 1 pada kompetisi Story Telling tingkat Nasional, kini ada lagi siswi yang 
        meraih juara 2 pada kompetisi tersebut. <br /> <br />

        Selamat kepada Naya Nasywa 8 PLUS 2 karena telah meraih juara 2 pada kompetisi Story Telling Tingkat Nasional.
    </>
  );
