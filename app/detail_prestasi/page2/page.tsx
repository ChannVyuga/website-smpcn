...
export default function PrestasiDetailPage() {
  ...
  const judul =
    "JUARA 1 TINGKAT NASIONAL! ISSC3 PIALA GUBERNUR DKI JAKARTA 2025";

  const foto = "/images/prestasi2.jpg";
  const kategori = "Prestasi";
  const tanggal = "15 September 2025";

  const deskripsi = (
    <>
      Sebuah prestasi puncak yang sangat membanggakan berhasil diraih oleh siswi terbaik {" "}
      <strong>SMP Citra Negara</strong>. Segenap keluarga besar {" "} Yayasan At-Taqwa Kemiri Jaya 
      dan {" "} <strong>SMP Citra Negara</strong> dengan penuh rasa syukur dan bangga mengucapkan {" "}
      <strong>SELAMAT & SUKSES</strong> kepada ananda, Ratu Easter Paulina Wadu dari kelas
      9 Reguler {" "} 1. <br /> <br />

      Atas keberhasilannya meraih <strong>JUARA 1 TINGKAT NASIONAL</strong> dalam <strong>Kejuaraan Taekwondo &ldquo;ISSC3 Piala Gubernur DKI Jakarta 2025&ldquo;</strong>
      yang di selenggarakan pada hari Jumat, 12 September 2025. <br /> <br />

      Medali emas ini adalah buah dari kerja keras, disiplin, dan semangat juang yang tak kenal lelah. Ratu telah
      menunjukan talenta terbaiknya dan berhasil berdiri di podium tertinggi, mengharumkan nama sekolah di kancah nasional. <br /> <br /> 

      Teruslah menjadi sang juara dan inspirasi bagi teman-temanmu. Kami semua bangga padamu!
    </>
  );
