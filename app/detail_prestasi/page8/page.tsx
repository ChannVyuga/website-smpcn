...
export default function PrestasiDetailPage() {
  ...
  const judul =
    "SISWI SMP CITRA NEGARA MERAIH JUARA 1 KOMPETISI STORY TELLING TINGKAT NASIONAL";

  const foto = "/images/prestasi8.jpg";
  const kategori = "Prestasi";
  const tanggal = "25 Desember 2023";

  const deskripsi = (
    <>
        Selamat kepada Marsha Azakia Putri. R 8 PLUS 2 karena telah meraih juara 1 pada kompetisi Story Telling Tingkat Nasional.
    </>
  );
