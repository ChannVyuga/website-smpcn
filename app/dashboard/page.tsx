...
const STATUS_CONFIG: Record<string, {
  ...
  lulus:           { label: 'Diterima / Lulus',    color: '#065F46', bg: '#D1FAE5', border: '#A7F3D0',  icon: Award,       step: 4, desc: 'Selamat! Anda dinyatakan LULUS dan diterima di SMP Citra Negara!' },
    ...
    <div style={{ minHeight: '100vh', background: '#FAF7F0' }}>
      <header style={{ background: 'linear-gradient(180deg, #123524 0%, #0B2A1C 100%)', borderBottom: '2px solid #C8973A', padding: '0 24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64 }}>
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
            ...
            <span style={{ color: 'white', fontWeight: 700, fontSize: 14 }}>SMP Citra Negara</span>
          </Link>
      ...
      <main style={{ maxWidth: 1100, margin: '0 auto', padding: '36px 24px' }}>
        <div style={{ marginBottom: 32 }}>
          ...
          <p style={{ color: '#6B7280', fontSize: 14 }}>Dashboard SPMB SMP Citra Negara</p>
        </div>
              ...
              {hasTes && (
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', margin: 0 }}>Dari SMP Citra Negara</p>
                    </div>
                  </div>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14, marginBottom: pendaftaran.infoTes ? 16 : 0 }}>
                    ...
                    <div style={{ background: 'rgba(255,255,255,0.06)', borderRadius: 10, padding: '12px 16px' }}>
                      ...
                      <div style={{ fontSize: 14, fontWeight: 600, color: 'white' }}>{pendaftaran.lokasiTes || 'SMP Citra Negara'}</div>
                    </div>
                  </div>
                  {pendaftaran.infoTes && (
              ...
              {(isLulus || isTidakLulus || isDaftarUlang) && (
                <div style={{ background: (isLulus || isDaftarUlang) ? 'linear-gradient(135deg,#1E3A8A,#3B82F6)' : 'linear-gradient(135deg,#991B1B,#B91C1C)', borderRadius: 16, padding: 32, color: 'white', textAlign: 'center' }}>
                  ...
                  <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: 14, lineHeight: 1.7, marginBottom: 16 }}>
                    {isDaftarUlang
                      ? 'Daftar ulang Anda telah dikonfirmasi. Selamat bergabung sebagai peserta didik baru SMP Citra Negara!'
                      : isLulus
                      ? 'Anda dinyatakan LULUS seleksi dan diterima sebagai peserta didik baru SMP Citra Negara!'
                      : 'Anda dinyatakan tidak lulus seleksi penerimaan peserta didik baru SMP Citra Negara.'}
                  </p>
