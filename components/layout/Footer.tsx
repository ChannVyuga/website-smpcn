        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 40, marginBottom: 40 }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
              ...
              <div>
                <div style={{ fontWeight: 800, fontSize: 15 }}>SMP Citra Negara</div>
            ...
            <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.6)', lineHeight: 1.7, marginBottom: 20 }}>
              Sekolah Menengah Pertama unggulan yang menggali potensi, mengasah bakat, dan membentuk pribadi yang cerdas serta berakhlak mulia.
            </p>
            <div style={{ display: 'flex', gap: 12 }}>
 <a
  href="https://www.instagram.com/smp_citra_negara/"
  target="_blank"
...
>
 ...
 <a
  href="https://www.youtube.com/@smpcitranegaraplusofficial"
  target="_blank"
  rel="noopener noreferrer"
  style={{
    width: 40,
...
>
 ...
 <a
  href="https://www.facebook.com/smpcitranegaraplus"
  target="_blank"
  rel="noopener noreferrer"
  style={{
    width: 40,
...
<a
  href="https://www.tiktok.com/@smpcitranegaraplus"
  target="_blank"
  rel="noopener noreferrer"
  style={{
    width: 40,
...
>
 ...
 <a
  href="https://wa.me/6287878724527"
  target="_blank"
  rel="noopener noreferrer"
  style={{
    width: 40,
...
>
  <FaWhatsapp size={18} />
          ...
          <div>
            ...
            {[
              { href: '/program_unggulan/WP', label: 'Web Programming' },
              { href: '/program_unggulan/HQ', label: 'Halaqoh Quran' },
              { href: '/program_unggulan/EPS', label: 'Entrepreneurship' },
              { href: '/program_unggulan/CVS', label: 'Conversation' },
            ].map((link) => (
              <Link
                key={link.href}
                href={link.href}
          ...
          <div>
            ...
            {[
              ...
              { Icon: Phone, text: '(021) 7720-1052 / WA: 0878-7872-4527' },
        ...
        <div style={{
          ...
          <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>
            © 2026 SMP Citra Negara. All rights reserved.
          </p>
          <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>
